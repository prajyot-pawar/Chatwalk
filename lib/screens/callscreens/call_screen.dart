...
class CallScreen extends StatefulWidget {
  final Call call;
  final String channelName1 = "sixthchannel";
...
class _CallScreenState extends State<CallScreen> {
  ...
  Future<void> getToken() async {
    String link =
        "https://agora-node-tokenserver.prashantnane.repl.co/access_token?channelName=${widget.channelName1}";
  ...
  Future<void> initializeAgora() async {
    ...
    await AgoraRtcEngine.joinChannel(TokenUrl, channelName, null, 0);
  }
